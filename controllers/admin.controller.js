...
const MostrarProductosAdmin = (nombre, precio, descripcion, imagen, id, categoria) => {
  ...
  <div class="producto__card__imagen" style="background-Image: url(${imagen})">
    <a class="boton-eliminar" id="${id}" href="#"><img src="../assets/eliminar-boton.svg" alt="boton eliminar"></a>
    <a class="boton-editar" href="../pages/editar-producto.html?id=${id}"><img src="../assets/editar-boton.svg" alt="boton editar"></a>
  </div>
